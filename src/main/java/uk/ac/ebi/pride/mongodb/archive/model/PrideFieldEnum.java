...
public enum PrideFieldEnum {
    ...
    PROJECT_SUBMISSION_DATE (PrideArchiveField.PROJECT_SUBMISSION_DATE, new String[]{PrideArchiveField.PRIDE_PROJECTS_COLLECTION_NAME}),
    PROJECT_PUBLICATION_DATE (PrideArchiveField.PROJECT_PUBLICATION_DATE, new String[]{PrideArchiveField.PRIDE_PROJECTS_COLLECTION_NAME}),
    PROJECT_UPDATED_DATE (PrideArchiveField.PROJECT_UPDATED_DATE, new String[]{PrideArchiveField.PRIDE_PROJECTS_COLLECTION_NAME}),
